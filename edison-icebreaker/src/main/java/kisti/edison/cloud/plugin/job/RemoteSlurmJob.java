...
public class RemoteSlurmJob {
	 ...
	 * Creates a new Job.
	 */
	public RemoteSlurmJob(String JobName, String ShellFile)
	{
		this.Name = JobName;
		this.executableFile = ShellFile;

	}
	public RemoteSlurmJob()
	{}
...
//		LOG.info("qdel cmd: " + cmd.toString());
	 ...
	 * @throws Exception
	 */
	public static RemoteSlurmJob getJobById(Cluster cluster, Job job, String id) throws IOException,InterruptedException,Exception
	{
