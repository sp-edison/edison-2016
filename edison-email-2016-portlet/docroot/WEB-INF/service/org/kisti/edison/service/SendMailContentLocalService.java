...
/**
 * Provides the local service interface for SendMailContent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see SendMailContentLocalServiceUtil
...
public interface SendMailContentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SendMailContentLocalServiceUtil} to access the send mail content local service. Add custom service methods to {@link org.kisti.edison.service.impl.SendMailContentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
