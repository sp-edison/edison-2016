...
public class ScienceAppWrapper implements ScienceApp, ModelWrapper<ScienceApp> {
	...
	*/
	...
	/**
	* Returns the sw test of this science app.
	*
	* @return the sw test of this science app
	*/
	@Override
	public boolean getSwTest() {
		return _scienceApp.getSwTest();
	}

	/**
	* Returns <code>true</code> if this science app is sw test.
	*
	* @return <code>true</code> if this science app is sw test; <code>false</code> otherwise
	*/
	@Override
	public boolean isSwTest() {
		return _scienceApp.isSwTest();
	}

	/**
	* Sets whether this science app is sw test.
	*
	* @param swTest the sw test of this science app
	*/
	@Override
	public void setSwTest(boolean swTest) {
		_scienceApp.setSwTest(swTest);
	}
