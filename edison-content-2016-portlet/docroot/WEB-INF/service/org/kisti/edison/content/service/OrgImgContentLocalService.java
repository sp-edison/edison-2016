...
/**
 * Provides the local service interface for OrgImgContent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see OrgImgContentLocalServiceUtil
...
public interface OrgImgContentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrgImgContentLocalServiceUtil} to access the org img content local service. Add custom service methods to {@link org.kisti.edison.content.service.impl.OrgImgContentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
