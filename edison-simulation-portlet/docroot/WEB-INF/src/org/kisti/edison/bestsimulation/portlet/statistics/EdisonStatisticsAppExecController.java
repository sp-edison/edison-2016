...
public class EdisonStatisticsAppExecController {
	...
	public String view(RenderRequest request, RenderResponse response, ModelMap model) throws PortalException, SystemException, WindowStateException {
		...
		Map map = new HashMap();
		map.put("groupId", visitSite);
		map.put("TOOLKIT_MY_LIST", "N");		
		map.put("begin", 0);
		map.put("scienceAppStatus", "1901004");
		
//		★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
//		map.put("end", SolverLocalServiceUtil.getCountCustomSolverId(map, themeDisplay.getLocale()));
		
		map.put("scienceApp_name_order", "Y");
		
		
		model.addAttribute("scienceAppList", ScienceAppLocalServiceUtil.retrieveListScienceApp(companyGroupId, GetterUtil.get(visitSite, 0L), 0, themeDisplay.getLocale(), new HashMap<String,Object>(), 0, 0, false));
//		model.addAttribute("solverList", SolverLocalServiceUtil.getListCustomSolverId(map, themeDisplay.getLocale()));
//		★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
	...
	public void getStatisticsSwExe(ResourceRequest request, ResourceResponse response) throws PortalException, SystemException, ParseException, IOException{
		Map params = RequestUtil.getParameterMap(request);
			...
			List tableOrganigationList  = SimulationJobLocalServiceUtil.getStatisticsSwExeTableOrganigation(groupId, themeDisplay.getLanguageId(), columnId, startDt, endDt, scienceAppId);

//			List pieChartOrganigationList  = SimulationJobLocalServiceUtil.getStatisticsSwExeTableOrganigation(groupId, startDt, endDt, scienceAppId);

			List barChartDateList  = SimulationJobLocalServiceUtil.getStatisticsSwExeBarChartDate(groupId, columnId, startDt, endDt, scienceAppId);
	...
	public void excelDown(ResourceRequest request, ResourceResponse response){
		...
		try {		
			...
			String appName = LanguageUtil.get(themeDisplay.getLocale(), "edison-table-list-header-app-title");
			...
			String scienceAppVersion = LanguageUtil.get(themeDisplay.getLocale(), "edison-appstore-solver-version");
