...
/**
 * Provides the local service interface for HistoryAppSimulation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see HistoryAppSimulationLocalServiceUtil
...
public interface HistoryAppSimulationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HistoryAppSimulationLocalServiceUtil} to access the history app simulation local service. Add custom service methods to {@link org.kisti.edison.project.service.impl.HistoryAppSimulationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
