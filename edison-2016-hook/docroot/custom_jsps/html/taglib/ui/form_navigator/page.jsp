...
//EDISON에서 Myaccount를 통하여 들어올경우
boolean edisonMyaccount = HttpUtil.getParameter(currentURL,"edison_myaccount",false)==""?false:true;
%>
				...
				<liferay-util:buffer var="formNavigatorBottom">
					<c:if test="<%= showButtons %>">
						<aui:button-row>
							...
							<%if(edisonMyaccount){ %>
<!-- 								<aui:button type="cancel" id="closeDialog"/> -->
							<%}else{ %>
