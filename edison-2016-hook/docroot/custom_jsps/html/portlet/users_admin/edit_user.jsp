...
<%
/*
* 회원 탈퇴 후 성공시 navigation 버튼 안보이도록
*/
...
<aui:script>
	function <portlet:namespace />deleteUser() {
		if(confirm("<liferay-ui:message key='edison-leave-message'/>")){
			<portlet:namespace />saveUser("<%=Constants.DEACTIVATE%>");
		}
	}
