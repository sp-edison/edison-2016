 ...
 * @generated
 */
public abstract class BoardDivActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BoardDivActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BoardDivLocalServiceUtil.getService());
		setClass(BoardDiv.class);

		setClassLoader(org.kisti.edison.multiboard.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("divCd");
	}
}