 ...
 * @generated
 */
public abstract class PortTypeInputdeckUserFormActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PortTypeInputdeckUserFormActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(PortTypeInputdeckUserFormLocalServiceUtil.getService());
		setClass(PortTypeInputdeckUserForm.class);

		setClassLoader(com.kisti.science.platform.app.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("inputdeckId");
	}
}